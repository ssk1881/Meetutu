...
<script src="https://apis.google.com/js/platform.js" async defer></script><meta name="google-signin-client_id" content="517088903669-an7k4nucf5552lstdgshi5u92fsnkf2d.apps.googleusercontent.com">
...
function myFunction() {
    ...
    var y = document.getElementById("learn").value;
    document.getElementById("learn").value = y+","+x;
}
</script>
    <style>
   body{
	...
	<div class="navbar-wrapper">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">MEETUTU</a>
                </div>
...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" action="learn_regist.php" method="post" autocomplete="on">
			<h2>Sign Up <small>Learner's SignUp</small></h2>
			<hr class="colorgraph">
			<div class="row">
			...
			<div class="form-group">
				<input type="text" name="learn" id="learn" class="form-control input-lg" placeholder="I Want To Learn" tabindex="4">
			</div>
			<div class="form-group">

				<select id="mySelect" onchange="myFunction()"class="selectpicker form-control input-lg" >
  <optgroup  label="Programming">
    <option value="Purescript">Purescript</option>
    <option valuew="Ruby">Ruby</option>
  ...
  <optgroup label="Designing">
    ...
    <option value="picsart">Picsart</option>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						<input type="password" name="confirm-password" id="password_confirmation" class="form-control input-lg" placeholder="Confirm Password" tabindex="7">
					</div>
				</div>
			</div>
			...
			<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-md-12 col-lg-12"><input type="submit" name="register-submit" value="Register" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
